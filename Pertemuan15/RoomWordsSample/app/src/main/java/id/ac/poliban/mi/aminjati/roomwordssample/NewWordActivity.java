...
import static id.ac.poliban.mi.aminjati.roomwordssample.MainActivity.UPDATE_WORD;
...
public class NewWordActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_REPLY = "id.ac.poliban.mi.aminjati.roomwordssample.REPLY";
    public static final String EXTRA_WORD_ID = "id.ac.poliban.mi.aminjati.roomwordssample.REPLY_ID";
